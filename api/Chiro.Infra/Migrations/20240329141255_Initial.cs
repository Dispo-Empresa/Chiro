        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<long>(type: "bigint", nullable: false),
                    LinkedTimelineActionId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TimelineActions_TimelineActions_LinkedTimelineActionId",
                        column: x => x.LinkedTimelineActionId,
                        principalTable: "TimelineActions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimelineActions_LinkedTimelineActionId",
                table: "TimelineActions",
                column: "LinkedTimelineActionId");
